...
const Education = ({ darkMode }) => {
  ...
  return (
    <section id="education" ref={scope} className="py-12 flex items-center justify-center px-4 relative">
      {/* Reduced from min-h-screen to py-12 */}
          ...
          {education.map((edu, index) => (
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-3">
                ...
                <span className={`inline-flex items-center px-3 py-1 bg-gradient-to-r ${edu.gradient} rounded-full text-white text-xs font-medium mb-3 md:mb-0`}>
                  {edu.period}
                </span>
              </div>
